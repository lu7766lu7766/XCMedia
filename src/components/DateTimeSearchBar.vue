  ...
  <div class="form-group">
    <div class="date-select m-r-10">
      <div class="input-group">
        <date-time-picker :value="startTime"
    ...
    <div class="date-select m-r-10">
      <div class="input-group">
        <date-time-picker :value="endTime"
    ...
    <div class="date-btn m-r-10">
      <button type="button" class="btn btn-day" data-toggle="button" @click="yesterday()">昨日</button>
      <button type="button" class="btn btn-day" data-toggle="button" @click="today()">今日</button>
      <button type="button" class="btn btn-day" data-toggle="button" @click="lastWeek()">上周</button>
      <button type="button" class="btn btn-day" data-toggle="button" @click="thisWeek()">本周</button>
      <button type="button" class="btn btn-month" data-toggle="button" @click="lastMonth()">上月</button>
      <button type="button" class="btn btn-month" data-toggle="button" @click="thisMonth()">本月</button>
    </div>
  </div>
</template>

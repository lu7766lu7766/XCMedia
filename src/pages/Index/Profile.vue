      ...
      <div class="">
        ...
        <div class="panel panel-inverse" style="clear:both;">
          ...
          <div class="panel-heading p-t-10">
            <h4 class="text-white m-b-0">个人资料</h4>
          </div>
          <!-- end panel-heading -->
          <!-- begin panel-body -->
          <div class="panel-body">
            ...
            <div class="form-group row m-b-15">
              ...
              <div class="col-md-6 col-lg-6">
                <div class="form-txt border-line">{{ data.account }}</div>
            ...
            <div class="form-group row m-b-15">
              ...
              <div class="col-md-6 col-lg-6">
                <validate rules="min:4|max:32" vid="old_password">
                  <input type="password" class="form-control" v-model="data.old_password">
            ...
            <div class="form-group row m-b-15">
              ...
              <div class="col-md-6 col-lg-6">
                <validate rules="confirmed:new_password">
                  <input type="password" class="form-control" v-model="data.new_password_confirmation">
                </validate>
              </div>
            </div>
            <div class="form-group row m-b-15">
              ...
              <div class="col-md-6 col-lg-6">
                <div class="form-txt border-line">{{ data.updated_at }}</div>
              </div>
            </div>
            <div class="form-group row m-b-15">
              ...
              <div class="col-md-6 col-lg-6">
                ...
                <div class="upload-info" v-if="photo.name">
                    ...
                    <table class="table table-bordered text-center">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <j-button type="delete" :action="true" :ignorePermission="true" @click="onDelete" />
                        </td>
                      </tr>
                      </tbody>
                    </table>

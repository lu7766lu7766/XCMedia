<template>
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right m-b-20">
      ...
      <li class="breadcrumb-item active">综艺管理</li>
    </ol>
    ...
    <div class="">
      <div class="panel panel-inverse" style="clear:both;">
        ...
        <div class="panel-heading p-t-10">
          <h4 class="text-white m-b-0">综艺管理</h4>
        </div>
        <!-- end panel-heading -->
        <!-- begin panel-body -->
              ...
              <tr v-for="(data, index) in datas" :key="index">
                ...
                <td class="text-left">
                  <j-button type="episode" :action="true"
                            @click="$router.push({name: 'variety-episode', params: {id: data.id}, query:{name: data.title}})"></j-button>

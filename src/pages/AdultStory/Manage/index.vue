          ...
          <div class="row m-b-20 justify-content-end panel-search-box">
            ...
            <div class="col-sm-10 form-inline justify-content-end panel-search">
              <div class="form-group width-100 m-r-10">
                <j-select v-model="search.region_id" title="地区" :datas="options.area" value-key="id" />
              </div>
              <div class="form-group width-100 m-r-10">
            ...
            <table class="table table-striped table-box text-center">
              ...
              <tbody>
                <tr v-for="(data, index) in datas" :key="index">
                  ...
                  <td>
                    <span v-for="(area, i) in data.genres" :key="i" class="label label-warning" style="margin-right:5px">{{
                      area.title
                    }}</span>
                  </td>

<template>
  <div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right m-b-20">
      ...
      <li class="breadcrumb-item"><a href="javascript:;">成人长片</a></li>
      <li class="breadcrumb-item"><a href="javascript:;">分类管理</a></li>
      <li class="breadcrumb-item active">罩杯设定</li>
    </ol>
    ...
    <div class="">
      <div class="panel panel-inverse" style="clear:both;">
        ...
        <div class="panel-heading p-t-10">
          <h4 class="text-white m-b-0">罩杯设定</h4>
        </div>
        <!-- end panel-heading -->
        <!-- begin panel-body -->
          ...
          <div class="row m-b-20 justify-content-end panel-search-box">
            ...
            <div class="col-sm-10 form-inline justify-content-end panel-search">
              ...
              <div class="form-group m-r-10">
                <input type="text" class="form-control" placeholder="请输入名称" v-model="search.size">
              </div>
